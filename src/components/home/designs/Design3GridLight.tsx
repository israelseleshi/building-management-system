...
export function Design3GridLight() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative pt-24 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <motion.div style={{ y: yParallax1 }} className="absolute inset-0 bg-grid-slate-200/[0.5] -z-10" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <motion.div
          style={{ y: useTransform(scrollY, [300, 800], [30, -30]) }}
          className="absolute top-0 right-0 w-96 h-96 bg-[#7D8B6F]/10 rounded-full blur-3xl -z-10"
        />
      ...
      <section className="py-16 bg-[#7D8B6F] relative overflow-hidden">
        <motion.div
          style={{ x: useTransform(scrollY, [500, 1000], [-50, 50]) }}
          className="absolute top-0 left-0 w-64 h-64 bg-white/10 rounded-full -z-10"
        />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <motion.div
          style={{ y: useTransform(scrollY, [800, 1300], [50, -50]) }}
          className="absolute bottom-0 left-0 w-96 h-96 bg-blue-500/5 rounded-full -z-10"
        />
