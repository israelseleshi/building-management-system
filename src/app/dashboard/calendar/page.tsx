                        ...
                        <div key={dateKey(d)} onClick={() => setSelectedDate(d)} onDragOver={(e) => e.preventDefault()} onDrop={(e) => {
                          ...
                          <div className="space-y-1 mt-1">
                            {list.slice(0, 3).map((e) => (
                              <div key={e.id} draggable={!e.autoGenerated} onDragStart={(de) => de.dataTransfer.setData("event-id", e.id)} className="w-full truncate rounded px-2 py-1 text-left text-[10px] font-medium text-slate-700" style={{ backgroundColor: eventTypeColor[e.type] }}>
                                {e.title}
                              </div>
                            ))}
