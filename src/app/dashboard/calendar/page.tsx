...
import { CalendarDays, ChevronLeft, ChevronRight, Mail, Plus } from "lucide-react"
                        ...
                        <div key={dateKey(d)} onClick={() => setSelectedDate(d)} onDragOver={(e) => e.preventDefault()} onDrop={(e) => {
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <button onClick={(e) => { e.stopPropagation(); const firstEvent = (eventsByDay.get(dateKey(d)) || [])[0] || null; if (firstEvent) { setEmailTargetEvent(firstEvent); setEmailModalOpen(true) } }} className="h-5 w-5 rounded bg-slate-100 text-slate-600 inline-flex items-center justify-center"><Mail className="h-3.5 w-3.5" /></button>
                            </div>
                          </div>
