...
function DashboardContent() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'buildings'>('overview')
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex rounded-lg border border-border bg-card p-1">
              <Button
                ...
                style={activeTab === 'overview' ? { backgroundColor: '#7D8B6F', color: '#FFFFFF' } : {}}
              >
              ...
              <Button
                ...
                className="rounded-md px-6 py-2 text-sm font-medium transition-all duration-200"
                style={activeTab === 'buildings' ? { backgroundColor: '#7D8B6F', color: '#FFFFFF' } : {}}
              >
